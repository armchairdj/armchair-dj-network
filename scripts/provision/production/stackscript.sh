...
su - deploy -c "(cd $HOME/app/current && git clone git@github.com:app/armchairdj.com.git .)"

##### Bootstrap

source "/home/deploy/app/current/scripts/tasks/files/environment_vars.production.bash"
