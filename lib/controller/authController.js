...
function renderRegisterPage(req, res, params, err) {
  ...
  render.page(req, res, 'armchairdj/page/auth/register', {
    headline:    i18n('headline.auth.register'),
    description: i18n('description.auth.register'),
    params:      params,
    error:       err || null
  });
}
...
function renderLoginPage(req, res, params, err) {
  ...
  render.page(req, res, 'armchairdj/page/auth/login', {
    headline:    i18n('headline.auth.login'),
    description: i18n('description.auth.login'),
    params:      params,
    error:       err || null
  });
}
