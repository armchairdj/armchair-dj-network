...
function show(req, res) {
  ...
  function respond() {
    render.page(req, res, 'armchairdj/page/user/profile', {
      headline:    i18n('headline.user.profile', req.user.username),
      description: i18n('description.user.profile', req.user.username),
      profile:     req.user
    });
  }
}
...
function renderEditPage(req, res) {
  ...
  function respond() {
    render.page(req, res, 'armchairdj/page/user/edit', {
