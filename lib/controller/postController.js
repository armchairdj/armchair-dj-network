...
// TODO BJD standard sort and limit should be built into the Post model
// instead of specified here in the controller
function renderIndex(req, res, criteria, options, locals) {
  ...
  function findPosts() {
    ...
    Post.displayMany(criteria, options, handleFind);
  }
