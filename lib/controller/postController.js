...
function playlists(req, res) {
  ...
  var locals   = {
    ...
    description: i18n('description.posts.playlist')
  };
...
function releases(req, res) {
  ...
  var locals   = {
    ...
    description: i18n('description.posts.release')
  };
...
function byTag(req, res) {
  ...
  var locals = {
    headline:    i18n('headline.posts.tag', req.tag.type, req.tag.title),
    description: i18n('description.posts.tag', req.tag.type, req.tag.title)
  };
