...
function homepage(req, res) {
  ...
  var locals   = {
    isHomepage:      true,
    pageDescription: i18n.site.tagline
  };
...
function releases(req, res) {
  ...
  var locals   = {
    headline:        'Releases',
    pageDescription: 'Latest track, album and mix reviews.'
  };
...
function byTag(req, res) {
  ...
  var locals = {
    headline:        [req.tag.type, req.tag.title].join(': '),
    pageDescription: 'Posts tagged with the ' + req.tag.type + ' ' + req.tag.title + '.',
  };
