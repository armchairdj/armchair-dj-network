/******************************************************************************
Middleware for interpreting URL paramters.
******************************************************************************/
...
function postTypeParam(req, res, next, postType) {
...
function tagTypeParam(req, res, next, tagType) {
  req.tagType = tagType;
...
module.exports = function (app) {
  ...
  app.param('post_type',   postTypeParam  );

  app.param('tag_id',      tagIdParam     );
  app.param('tag_slug',    tagSlugParam   );
  app.param('tag_type',    tagTypeParam   );
