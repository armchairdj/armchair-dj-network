...
// TODO BJD We shouldn't require published
// if user is admin and it's for a form
...
// TODO BJD Can we have params for tagType and tagName
// but do a single lookup based on both?
function tagNameParam(req, res, next, tagName) {
  var Tag = mongoose.model('Tag');

  Tag.find({ name: tagName }, handleTag);
...
module.exports = function (app) {
  ...
  app.param('tag_name',    tagNameParam   );
