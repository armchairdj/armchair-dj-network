/******************************************************************************
Playlist model for building lists of tracks.
******************************************************************************/
...
extend(schema.methods, {
  htmlTitle: function () {
    return i18n('armchairdj.headline.post.playlist', this.seriesPrefix(), this.title);
  },

  metaDescription: function () {
    var artists = _.chain(this.tracks).pluck('artist').uniq().slice(0, 5).value();

    return i18n('armchairdj.description.post.playlist', artists.join(', '));
  },
