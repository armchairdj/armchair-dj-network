...
extend(schema.methods, {
  htmlTitle: function () {
    return i18n('armchairdj.headline.post.playlist', this.artist, this.displayTitle());
  },

  metaDescription: function () {
    return i18n('armchairdj.description.post.release', this.type, this.displayTitle(), this.artist);
  },
